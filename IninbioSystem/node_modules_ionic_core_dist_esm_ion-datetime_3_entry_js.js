...
let Datetime = class {
  ...
  renderTimeOverlay(hoursItems, minutesItems, ampmItems, use24Hour) {
    ...
    return [(0,_index_06cd27b1_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      ...
      "aria-haspopup": "true",
      onClick: function () {
        var _ref = (0,C_Users_tics_Documents_BACKUP_APP_ESCRITORIO_FULL_IninbioSystemExpo_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev) {
          const {
            popoverRef
          } = _this4;
