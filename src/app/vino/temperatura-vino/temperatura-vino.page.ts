...
@Component({
  ...
  templateUrl: './temperatura-vino.page.html',
  styleUrls: ['./temperatura-vino.page.scss'],
})
export class TemperaturaVinoPage implements OnInit {
    ...
    $.ajax({
      ...
      success: function (datosGrafica) {
        ...
        $.each(datosGrafica, function (key, value) {
          ...
          if (value.temperatura) { datosGrafica[key].temperatura = parseFloat(value.temperatura); }
